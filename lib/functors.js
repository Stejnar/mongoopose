/**
 * @param pipe {Parameters}
 * @param query {function(Parameters)}
 * @param action {function(resolve, reject, Parameters)}
 * @return {Promise}
 */
...
module.exports = (model, singular, plural) => ({
     ...
     * Model.findById
     * @type Function
     * @param query {function(Parameters)} [params => params]
     * @return {function(Parameters): Promise}
     * @api public
     */
